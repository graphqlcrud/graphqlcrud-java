...
//            Assertions.assertEquals(result4,"SELECT PUBLIC.CUSTOMER.SSN,PUBLIC.ACCOUNT.ACCOUNT_ID FROM PUBLIC.CUSTOMER INNER JOIN PUBLIC.ACCOUNT ON PUBLIC.CUSTOMER.SSN = PUBLIC.ACCOUNT.SSN");
        }
    }
